...
@Data
@Schema(description = "DTO de una orden obtenida desde ms-orders")
public class OrderDTO {
    ...
    @Schema(description = "Estado de la orden", example = "PAID")
    ...
    @Schema(description = "Monto total", example = "36.0")
    private Double totalAmount;

    @Schema(description = "Fecha de creación", example = "2026-06-08T10:30:00")
